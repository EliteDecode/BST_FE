...
import review3 from "../../assets/Screensho.jpg"
...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      Title={'Programs'} 
      courseKey={1} 
      courseLabel={"ADVANCED EXCEL"} 
      courseDes={ "Learn advanced Excel formulas essential for developing skills in data analysis, data manipulation, and solving complex calculations"}

      courseKey2={2} 
      courseLabel2={"POWER BI"} 
      courseDes2={  "Gain proficiency in sharing, visualizing, and presenting report dashboards professionally and effectively manage and process information in relational databases."}

      courseKey3={3} 
      courseLabel3={"SQL"} 
      courseDes3={  "Develop expertise in SQL, covering both fundamentals and advanced concepts. Learn to efficiently manage and process information in relational databases."}

      courseKey4={4} 
      courseLabel4={"Python"} 
      courseDes4={  "Explore Python an interpreted, object-oriented, high-level programming language with dynamic semantics, encompassing syntax, data types, control flow, and functions."}

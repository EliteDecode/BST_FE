...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      courseKey4={4} 
      courseLabel4={"PYTHON"} 
      courseDes4={ "Embark on your Python journey, a versatile programming adventure. Discover syntax, data structures, and libraries for endless application possibilities."}

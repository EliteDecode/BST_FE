...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      Title={'Programs'} 
      courseKey={1} 
      courseLabel={"HTML(Hyper Text Markup Language)"} 
      courseDes={ "Understand the basics of HTML through simple explanations and practical examples. Dive deeper into tags, elements, and structure for web development."}

      courseKey2={2} 
      courseLabel2={"CSS(Cascading Style Sheet)"} 
      courseDes2={  "Master the fundamentals of CSS, including selectors, properties, and styling techniques. Explore how to create visually appealing web pages."}

      courseKey3={3} 
      courseLabel3={"Javascript"} 
      courseDes3={  "Explore the essentials of JavaScript, from variables and data types to functions and control flow. Learn how to manipulate web page elements dynamically."}

      courseKey4={4} 
      courseLabel4={"React"} 
      courseDes4={ "Master React, a javascript library essentail for dynamic web interfaces. Learn JSX and component-based web development."}
      
      courseKey5={5} 
      courseLabel5={"Node"} 
      courseDes5={ "Boost your backend programming prowess with Node.js Hone your grasp of essential Node.js modules, and asynchronous programming."}
      
      courseKey6={6} 
      courseLabel6={"Mongo DB"} 
      courseDes6={ "Unlock the potential of MongoDB, a NoSQL database renowned for its flexible cshema and horizontal scalability, idea for managing big data."}
      
      courseKey7={7} 
      courseLabel7={"Express"} 
      courseDes7={ "Master Express.js the Node.js framework simplifying web appliation and API development. Explore its routing and HTTP utility methods for efficient coding."}
      
      courseKey8={8} 
      courseLabel8={"Git"} 
      courseDes8={ "Delve into React, a popular JavaScript library for building user interfaces. Learn how to create reusable components and manage state effectively."}
...
<StudentReview reviewImg={review2} reviewImg2={review1} reviewImg3={review3}/>

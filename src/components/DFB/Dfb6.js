...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      courseKey={1} 
      courseLabel={"PUPPETS"} 
      courseDes={ "Enter the world of Puppet in DevOps, your automation ally. Learn configuration management, infrastructure as code, and deployment orchestration for streamlined operations."}

      courseKey2={2} 
      courseLabel2={"GIT"} 
      courseDes2={  "Embark on your Git journey, a cornerstone of version control. Dive into repositories, branching, and collaboration for efficient code management."}

      courseKey3={3} 
      courseLabel3={"DOCKER"} 
      courseDes3={  "Embark on your Docker journey, a containerization marvel. Explore images, containers, and orchestration for scalable and portable application deployment."}

      courseKey4={4} 
      courseLabel4={"JEKINS"} 
      courseDes4={ "Embark on your Jenkins journey, an automation powerhouse. Learn pipelines, jobs, and integrations for seamless software development and delivery."}

...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      courseKey={1} 
      courseLabel={"TABLEAU"} 
      courseDes={ "Begin your Tableau journey, a data visualization marvel. Explore data connections, dashboards, and analytics for insightful data-driven decision-making."}

      courseKey2={2} 
      courseLabel2={"JUPYTER"} 
...
<StudentReview reviewImg={review3} reviewImg2={review2} reviewImg3={review1}/>

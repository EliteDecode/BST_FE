...
// const AutoplaySlider = withAutoplay();
...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      courseKey={1} 
      courseLabel={"FIGMA"} 
      courseDes={ "Unlock Figma's potential as a design ally. Start with shaping objects, organizing layers, and teaming up for smoother projects."}

      courseKey2={2} 
      courseLabel2={"PHOTOSHOP"} 
      courseDes2={  "Begin your Photoshop adventure, a design powerhouse. Dive into layers, tools, and photo editing essentials for creative mastery."}

      courseKey3={3} 
      courseLabel3={"ADOBE XD"} 
      courseDes3={  "Embark on your XD journey, a design hub. Explore artboards, components, and prototyping for seamless design experiences."}
...
{/* 
  <AutoplaySlider
    ...
    interval={6000}
  >
    <div data-src={review1} />
    <div data-src={review2} />
    <div data-src={review2} />
  </AutoplaySlider>
 */}

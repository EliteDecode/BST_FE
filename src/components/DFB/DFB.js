...
import review1 from "../../assets/WhatsApp Image 2024-05-10 at 4.52.52 AM.jpeg"
...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      courseKey4={4} 
      courseLabel4={"React"} 
      courseDes4={ "Delve into React, a popular JavaScript library for building user interfaces. Learn how to create reusable components and manage state effectively."}

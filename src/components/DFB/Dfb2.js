...
import review3 from "../../assets/WhatsApp Image 2024-05-10 at 4.52.52 AM.jpeg"
import review2 from "../../assets/Screensho.jpg"
import review1 from "../../assets/Reviews 5.jpg"
...
function DFB({ cardOneTitle, cardTwoTitle, cardThreeTitle }) {
  return (
    ...
    <h1 className="text-center midSmall:text-[40px] text-[30px] font-bold py-5"> Specially Crafted for beginners</h1>
      ...
      Title={'Programs'} 
      courseKey={1} 
      courseLabel={"Php(Hypertext Preprocessor)"} 
      courseDes={ "Master the fundamentals of PHP, including syntax, variables, control structures, functions, and frameworks like Laravel for web application development."}

      courseKey2={2} 
      courseLabel2={"Node.js(Open Source, cross-platform runtime environment for executing JavaScript code)"} 
      courseDes2={  " Master the fundamentals of Node.js, including asynchronous JavaScript, modules, npm, and Express.js for server-side web development."}

      courseKey3={3} 
      courseLabel3={"Python"} 
      courseDes3={  "Explore Python an interpreted, object-oriented, high-level programming language with dynamic semantics, encompassing syntax, data types, control flow, and functions."}

      courseKey4={4} 
      courseLabel4={"Mongo DB"} 
      courseDes4={ "Master the fundamentals of MongoDB, covering document-oriented database concepts, CRUD operations, aggregation framework, indexing, and schema design.."}
...
<StudentReview reviewImg={review1} reviewImg2={review2} reviewImg3={review3}/>

  ...
  return (
    <div className="data-b flex gap-2 my-2">
      <svg
        ...
        <path
          fill="#4d77cf"
          d="m15.08 15.5l-3.674-1.861v8.045S6.913 12.05 6.5 11.185a.9.9 0 0 0-.331-.264C5.361 10.5 3 9.29 3 9.29V23.5l3.266 1.76v-7.428s4.445 8.607 4.49 8.7a4 4 0 0 0 .968 1.32c.635.423 3.357 2.073 3.357 2.073Z"
        />
      </svg>
      <svg
        xmlns="http://www.w3.org/2000/svg"

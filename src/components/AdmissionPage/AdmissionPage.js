        ...
        <div>
          ...
          <Grid container style={{ marginTop: 40 }}>
            <Grid xs={12} sm={12} md={6}>
              <div className="w-full mt-5 p-8 bg-white shadow-lg rounded-lg">
                ...
                <form
                  ...
                  {formik.values.scheduleCall && (
                    <FormControl
                      ...
                      size="small"
                      error={
                        formik.touched.callTime &&
                        Boolean(formik.errors.callTime)
                      }>
            ...
            <Grid xs={12} sm={12} md={6}>
              <div className="mt-5 px-8">
                ...
                <p className="mt-5" style={{ fontFamily: "Raleway" }}>
                  Africa's booming tech scene needs YOU! This Advanced Diploma
                  course equips you with the skills to excel in Software
                  Engineering, Data Science & AI, and Cyber Security.
                  <br /> <br />
                  ...
                  engineers!).
                  <br /> <br />
                  This program goes beyond technical skills, it's designed to
                  help you stand out in Africa's tech boom! Master in-demand
                  skills & develop the problem-solving, curiosity, and teamwork
                  employers crave. Limited spots - secure yours today!
                  <br /> <br />
                  Take action today and become a future tech leader!
                </p>
              </div>
            </Grid>
          </Grid>
